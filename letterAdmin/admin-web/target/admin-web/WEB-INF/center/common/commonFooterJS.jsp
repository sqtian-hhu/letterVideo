...
<input type="hidden" id="apiServer" name="apiServer" value="http://192.168.43.3:8080"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://192.168.43.3:80/mvc"/>
