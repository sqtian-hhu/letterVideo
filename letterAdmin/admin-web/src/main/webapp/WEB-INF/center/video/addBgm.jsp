...
<script type="text/javascript">
	...
	// $("#file") 对应<input id="file" type="file" name="file" data-url="<%=request.getContextPath() %>/video/bgmUpload.action" accept=".mp3"/>
			$("#file").fileupload({
	...
	// 对应<form id="addBgmForm" class="form-horizontal">
