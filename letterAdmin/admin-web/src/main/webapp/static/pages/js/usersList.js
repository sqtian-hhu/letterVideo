	...
	var handleList = function() {
        ...
        jqGrid.jqGrid({  
            ...
            colModel: [  
                ...
                { name: 'fansCounts', index: 'fans_counts', width: 20, sortable: false },
                { name: 'followCounts', index: 'follow_counts', width: 20, sortable: false },
                { name: 'receiveLikeCounts', index: 'receive_like_counts', width: 20, sortable: false, hidden: false }
            ],  
