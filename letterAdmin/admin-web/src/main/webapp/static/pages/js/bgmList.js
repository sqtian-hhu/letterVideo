var BgmList = function() {
    ...
    var handleBgmList = function() {
        ...
        /**
         * bgmServer要在配置文件里配好正确ip和端口,同时tomcat路径的server.xml里配置虚拟路径
         * @type {jQuery|*}
         */
            ...
            colModel: [
                ...
                { name: 'path', index: 'path', width: 50,
                    ...
                    formatter: function(cellvalue,option,rowObject){
                        ...
                        var html = "<a href='"+ src + "'target='_blank'>播放</a>"
                        return html;
                    }
...
var deleteBgm = function(bgmId){
    var flag = window.confirm("are you really???");
    if(!flag){
        return;
    }
