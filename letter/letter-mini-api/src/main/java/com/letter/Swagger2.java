...
//        pars.add(userIdHeader.build());
        ...
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select()
                .apis(RequestHandlerSelectors.basePackage("com.letter.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                // 设置联系人
                .contact(new Contact("letter-尺素", "https://sqtian-hhu.github.io", "sqtian_hhu@163.com"))
                // 描述
